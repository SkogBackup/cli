...
Run the `/hooks` [slash command](/e.skogai/docs/claude-code/slash-commands) and select
...
[settings files](/e.skogai/docs/claude-code/settings):
...
[Model Context Protocol (MCP) tools](/e.skogai/docs/claude-code/mcp). When MCP servers
    ...
    "PreToolUse": [
      ...
      },
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "/home/use.skogai/scripts/validate-mcp-write.py"
          }
        ]
      }
    ]
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "/home/use.skogai/scripts/format-code.sh"
          }
        ]
      }
    ]
...
2. Verify that your [settings files](/e.skogai/docs/claude-code/settings) are valid
   JSON
