...
#         app, ["examples", "basic", "--count", "2", "--formal", "skogix"]
#     )
#     assert result.exit_code == 0
...
#     result = runner.invoke(
#         app, ["examples", "choices", "--format", "text", "item1", "item2"]
#     )
#     assert result.exit_code == 0
#     assert "item1" in result.stdout
#     assert "item2" in result.stdout
...
#     result = runner.invoke(
#         app, ["examples", "choices", "--format", "json", "item1", "item2"]
#     )
#     assert result.exit_code == 0
...
#     result = runner.invoke(
#         app, ["examples", "callback", "--verbose", "file1.txt", "file2.txt"]
#     )
#     assert result.exit_code == 0
#     assert "Processing 2 files:" in result.stdout
#     assert "file1.txt" in result.stdout
...
#             if (
#                 hasattr(callback, "_explanation")
#                 and len(ctx.args) == 0
#                 and len(ctx.params) == 1
#             ):
...
#     assert (
#         verify_explanation._explanation == "This is a test explanation for the command."
#     )
#
